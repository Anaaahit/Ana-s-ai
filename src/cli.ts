...
import { registerUser, loginUser, verifySession, invalidateSession, createGuestSession, updateAvatar } from "./auth";
...
// generated guest name straight away, no registration needed.
